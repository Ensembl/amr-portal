        ...
        <div class="amr-container">
            <Switch>
                ...
                <Match when={modalMode() === 'delete'}>
                    <DeleteModal modalMode={modalMode()} setModalMode={setModalMode} onCancel={() => setModalMode("table")} />
                </Match>
                <Match when={modalMode() === 'download'}>
                    <DownloadModal modalMode={modalMode()} setModalMode={setModalMode} onCancel={() => setModalMode("table")} />
                </Match>
            </Switch>
            <div class="amr-body">
                <Switch>
                    <Match when={!store.amrData || !Array.isArray(store.amrData.data) || store.amrData.data.length === 0}>
