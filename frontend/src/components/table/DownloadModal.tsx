      ...
      <div class="download-modal-body">
        <div class="download-modal-content">
          ...
          <div class="download-modal-content-body">
            <label class="download-modal-checkbox-label">
              <input type="checkbox" disabled /> Downloadable data
            </label>
            <label class="download-modal-checkbox-label">
              <input type="checkbox" disabled /> Data shown in table
            </label>
          </div>
        </div>
        <div class="download-modal-button-group">
          <button disabled>Download</button>
          <ens-text-button class="download-modal-cancel-button" onClick={onCancel}>
            Cancel
          </ens-text-button>
        </div>
      </div>
