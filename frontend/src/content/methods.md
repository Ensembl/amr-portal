...
[mettannotator][mettannotator] is a bioinformatics pipeline that generates an exhaustive annotation of prokaryotic genomes using existing tools. The output is a GFF file that integrates the results of all pipeline components. Results of each individual tool are also provided. Version `4.0.23` of [AMRFinder][AMRFinderPlus] was used alongside database version `4.0 2025-07-16.1`. In future versions [UniFire][UniFire] will be used to generate additional _in silico_ predictions. [v1.4.0 of mettannotator][mettannotatortag] was used by this portal.
